    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, upload_to='users/profile_pictures', verbose_name='Аватар')),
        ...
        migrations.AddConstraint(
            model_name='subscription',
            constraint=models.CheckConstraint(condition=models.Q(('subscriber', models.F('author')), _negated=True), name='check_subscription_prevent_self_subscription'),
        ),
    ]
